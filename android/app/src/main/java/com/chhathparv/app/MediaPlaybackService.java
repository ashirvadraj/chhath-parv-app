...
public class MediaPlaybackService extends Service {
    ...
    public static final String CHANNEL_ID = "chhath_parv_playback_channel";
    ...
    public void onCreate() {
        ...
        mediaSession = new MediaSessionCompat(this, "ChhathParvPlaybackSession");
        ...
        if (pm != null) {
            wakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "chhathparv:mediaPlaybackWakeLock");
            wakeLock.setReferenceCounted(false);
        }

        WifiManager wm = (WifiManager) getApplicationContext().getSystemService(Context.WIFI_SERVICE);
        if (wm != null) {
            wifiLock = wm.createWifiLock(WifiManager.WIFI_MODE_FULL_HIGH_PERF, "chhathparv:mediaPlaybackWifiLock");
